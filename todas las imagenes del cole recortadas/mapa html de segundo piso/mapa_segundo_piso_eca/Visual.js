...
var arrPontos = [
      ...
      criarPonto(990, 885), //1
      criarPonto(990, 1423), //2
      criarPonto(990, 1590), //3
      criarPonto(990, 2360), //4
      criarPonto(990, 2440), //5
      criarPonto(600, 1423), //6
      criarPonto(600, 1590), //7
      criarPonto(600, 2360), //8
      criarPonto(1200, 2440), //9
...
g.criarConexao(arrPontos[6], arrPontos[2], parseInt(1));
g.criarConexao(arrPontos[7], arrPontos[3], parseInt(1));
g.criarConexao(arrPontos[8], arrPontos[4], parseInt(1));
g.criarConexao(arrPontos[9], arrPontos[5], parseInt(1));
