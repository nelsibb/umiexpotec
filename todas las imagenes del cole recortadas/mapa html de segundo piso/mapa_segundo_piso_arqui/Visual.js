...
var arrPontos = [
      ...
      criarPonto(990, 2100), //1
      criarPonto(990, 1630), //2
      criarPonto(990, 1040), //3
      criarPonto(710, 1630), //4
      criarPonto(990, 1000), //5
      criarPonto(1290, 1000), //6
      criarPonto(710, 1040), //7
      criarPonto(890, 900), //8
      criarPonto(710, 900), //9
      criarPonto(1010, 1200), //10
      criarPonto(1010, 1450), //11
      criarPonto(1010, 660), //12
      criarPonto(1140, 660), //13
      criarPonto(690, 660), //14
      criarPonto(690, 500), //15
      criarPonto(520, 500), //16
...
g.criarConexao(arrPontos[3], arrPontos[5], parseInt(1));
g.criarConexao(arrPontos[6], arrPontos[5], parseInt(1));
g.criarConexao(arrPontos[7], arrPontos[3], parseInt(1));
g.criarConexao(arrPontos[5], arrPontos[8], parseInt(1));
