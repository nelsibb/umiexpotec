...
var arrPontos = [
  ...
  criarPonto(290, 450), //0
  criarPonto(780, 520), //1
  criarPonto(780, 1230), //2
  criarPonto(780, 1290), //3
  criarPonto(780, 1565), //4
  criarPonto(780, 1610), //5
  criarPonto(780, 2120), //6
  criarPonto(780, 2240), //7
  criarPonto(1000, 1230), //8
  criarPonto(550, 1290), //9
  criarPonto(1000, 1565), //10
  criarPonto(550, 1610), //11
  criarPonto(1000, 2120), //12
  criarPonto(780, 2450), //13
  criarPonto(1000, 2240), //14
  criarPonto(1000, 2450), //15
  criarPonto(1100, 2240), //16
  criarPonto(780, 1015), //17
  criarPonto(550, 1015), //18
...
g.criarConexao(arrPontos[17], arrPontos[1], parseInt(1));
...
g.criarConexao(arrPontos[6], arrPontos[7], parseInt(1));
g.criarConexao(arrPontos[2], arrPontos[8], parseInt(1));
g.criarConexao(arrPontos[3], arrPontos[9], parseInt(1));
...
g.criarConexao(arrPontos[7], arrPontos[14], parseInt(1));
g.criarConexao(arrPontos[15], arrPontos[14], parseInt(1));
g.criarConexao(arrPontos[14], arrPontos[16], parseInt(1));
