...
var arrPontos = [
      ...
      criarPonto(865, 530), //0
      criarPonto(865, 590), //1
      criarPonto(610, 590), //2
      criarPonto(610, 360), //3
      criarPonto(865, 790), //4
      criarPonto(770, 790), //5
      criarPonto(890, 790), //6
      criarPonto(890, 1220), //7
      criarPonto(890, 1460), //8
      criarPonto(890, 1550), //9
      criarPonto(1170, 1460), //10
      criarPonto(890, 2007), //11
      criarPonto(890, 2090), //12
      criarPonto(650, 1550), //13
      criarPonto(650, 2007), //14
      criarPonto(650, 2090), //15
      criarPonto(650, 1220), //16
      criarPonto(890, 1876), //17
      criarPonto(1000, 1876), //18
      criarPonto(1070, 1220), //19
      criarPonto(890, 2410), //20
      criarPonto(1070, 2410), //20
...
g.criarConexao(arrPontos[17], arrPontos[9], parseInt(1));
g.criarConexao(arrPontos[17], arrPontos[11], parseInt(1));
g.criarConexao(arrPontos[11], arrPontos[12], parseInt(1));
g.criarConexao(arrPontos[9], arrPontos[13], parseInt(1));
g.criarConexao(arrPontos[11], arrPontos[14], parseInt(1));
g.criarConexao(arrPontos[12], arrPontos[15], parseInt(1));
g.criarConexao(arrPontos[7], arrPontos[16], parseInt(1));
g.criarConexao(arrPontos[17], arrPontos[18], parseInt(1));
g.criarConexao(arrPontos[7], arrPontos[19], parseInt(1));
g.criarConexao(arrPontos[12], arrPontos[20], parseInt(1));
g.criarConexao(arrPontos[21], arrPontos[20], parseInt(1));
